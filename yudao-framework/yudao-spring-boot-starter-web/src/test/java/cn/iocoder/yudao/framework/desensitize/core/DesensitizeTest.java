...
public class DesensitizeTest {
    ...
    public void test() {
        ...
        desensitizeDemo.setNickname("X-ERP源码");
        ...
        desensitizeDemo.setRegex("你好，我是X-ERP源码");
        desensitizeDemo.setAddress("北京市海淀区上地十街10号");
        desensitizeDemo.setOrigin("X-ERP源码");
        ...
        assertEquals("X-ERP源码", d.getOrigin());
    }
    ...
    public static class DesensitizeDemo {
        ...
        @RegexDesensitize(regex = "X-ERP源码", replacer = "*")

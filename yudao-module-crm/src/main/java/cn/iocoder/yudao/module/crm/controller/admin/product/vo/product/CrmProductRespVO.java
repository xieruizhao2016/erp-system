...
public class CrmProductRespVO implements VO {
    ...
    @Schema(description = "负责人的用户昵称", requiredMode = Schema.RequiredMode.REQUIRED, example = "X-ERP源码")
    @ExcelProperty("负责人")
    ...
    @Schema(description = "创建人名字", requiredMode = Schema.RequiredMode.REQUIRED, example = "X-ERP源码")
    @ExcelProperty("创建人")

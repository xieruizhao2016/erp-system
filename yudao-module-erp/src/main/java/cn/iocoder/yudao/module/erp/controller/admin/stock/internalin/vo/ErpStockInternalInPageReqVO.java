package cn.iocoder.yudao.module.erp.controller.admin.stock-internal-in.vo;
...
@Schema(description = "管理后台 - 内部入库单分页 Request VO")
@Data
public class ErpStockInternalInPageReqVO extends PageParam {

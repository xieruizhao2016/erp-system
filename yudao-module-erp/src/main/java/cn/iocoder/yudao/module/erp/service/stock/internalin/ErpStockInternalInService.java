...
public interface ErpStockInternalInService {
     ...
     * @return 编号
     */
    Long createStockInternalIn(@Valid ErpStockInternalInSaveReqVO createReqVO);
     ...
     * @param id 编号
     */
    void deleteStockInternalIn(Long id);
    ...
    * @param ids 编号
    */
    void deleteStockInternalInListByIds(List<Long> ids);
     ...
     * @return 内部入库单
     */
    ErpStockInternalInDO getStockInternalIn(Long id);
     ...
     * @param status 状态
     */
    void updateStockInternalInStatus(Long id, Integer status);

...
public interface ErrorCodeConstants {
    ...
    ErrorCode DICT_DATA_CAN_NOT_UPDATE_SYSTEM = new ErrorCode(1_002_007_004, "系统默认字典数据不可修改");
    ErrorCode DICT_DATA_CAN_NOT_DELETE_SYSTEM = new ErrorCode(1_002_007_005, "系统默认字典数据不可删除");

package cn.iocoder.yudao.module.erp.service.finance-profit-statement;
...
import cn.iocoder.yudao.module.erp.dal.mysql.finance-profit-statement.ErpFinanceProfitStatementMapper;
...
public class ErpFinanceProfitStatementServiceImpl implements ErpFinanceProfitStatementService {
    ...
    @Override
    public ${primaryColumn.javaType} createFinanceProfitStatement(ErpFinanceProfitStatementSaveReqVO createReqVO) {
        // 插入
    ...
    @Override
    public void deleteFinanceProfitStatement(${primaryColumn.javaType} id) {
        // 校验存在
    ...
    @Override
        public void deleteFinanceProfitStatementListByIds(List<${primaryColumn.javaType}> ids) {
        // 删除
        financeProfitStatementMapper.deleteByIds(ids);
        }


    private void validateFinanceProfitStatementExists(${primaryColumn.javaType} id) {
    ...
    @Override
    public ErpFinanceProfitStatementDO getFinanceProfitStatement(${primaryColumn.javaType} id) {

...
public interface ErpFinancePrepaymentService {
     ...
     * @return 编号
     */
    ${primaryColumn.javaType} createFinancePrepayment(@Valid ErpFinancePrepaymentSaveReqVO createReqVO);
     ...
     * @param id 编号
     */
    void deleteFinancePrepayment(${primaryColumn.javaType} id);
    ...
    * @param ids 编号
    */
    void deleteFinancePrepaymentListByIds(List<${primaryColumn.javaType}> ids);
     ...
     * @return 预付款
     */
    ErpFinancePrepaymentDO getFinancePrepayment(${primaryColumn.javaType} id);

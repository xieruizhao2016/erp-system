...
public interface ErpFinancePrereceiptService {
     ...
     * @return 编号
     */
    ${primaryColumn.javaType} createFinancePrereceipt(@Valid ErpFinancePrereceiptSaveReqVO createReqVO);
     ...
     * @param id 编号
     */
    void deleteFinancePrereceipt(${primaryColumn.javaType} id);
    ...
    * @param ids 编号
    */
    void deleteFinancePrereceiptListByIds(List<${primaryColumn.javaType}> ids);
     ...
     * @return 预收款
     */
    ErpFinancePrereceiptDO getFinancePrereceipt(${primaryColumn.javaType} id);

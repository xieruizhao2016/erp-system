package cn.iocoder.yudao.module.erp.service.finance-balance-sheet;
...
import cn.iocoder.yudao.module.erp.dal.mysql.finance-balance-sheet.ErpFinanceBalanceSheetMapper;
...
public class ErpFinanceBalanceSheetServiceImpl implements ErpFinanceBalanceSheetService {
    ...
    @Override
    public ${primaryColumn.javaType} createFinanceBalanceSheet(ErpFinanceBalanceSheetSaveReqVO createReqVO) {
        // 插入
    ...
    @Override
    public void deleteFinanceBalanceSheet(${primaryColumn.javaType} id) {
        // 校验存在
    ...
    @Override
        public void deleteFinanceBalanceSheetListByIds(List<${primaryColumn.javaType}> ids) {
        // 删除
        financeBalanceSheetMapper.deleteByIds(ids);
        }


    private void validateFinanceBalanceSheetExists(${primaryColumn.javaType} id) {
    ...
    @Override
    public ErpFinanceBalanceSheetDO getFinanceBalanceSheet(${primaryColumn.javaType} id) {

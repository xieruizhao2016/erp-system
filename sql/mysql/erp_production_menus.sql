...
-- 菜单
INSERT INTO `system_menu` (`id`, `name`, `permission`, `type`, `sort`, `parent_id`, `path`, `icon`, `component`, `component_name`, `status`, `visible`, `keep_alive`, `always_show`, `creator`, `create_time`, `updater`, `update_time`, `deleted`) 
VALUES (5049, '生产订单', '', 2, 1, 5042, 'production-order', 'ep:document', 'erp/productionorder/index', 'ProductionOrder', 0, b'1', b'1', b'1', '1', NOW(), '1', NOW(), b'0');
...
VALUES 
('生产订单查询', 'erp:production-order:query', 3, 1, @parentId, '', '', '', 0, b'1', b'1', b'1', '1', NOW(), '1', NOW(), b'0'),
('生产订单创建', 'erp:production-order:create', 3, 2, @parentId, '', '', '', 0, b'1', b'1', b'1', '1', NOW(), '1', NOW(), b'0'),
('生产订单更新', 'erp:production-order:update', 3, 3, @parentId, '', '', '', 0, b'1', b'1', b'1', '1', NOW(), '1', NOW(), b'0'),
('生产订单删除', 'erp:production-order:delete', 3, 4, @parentId, '', '', '', 0, b'1', b'1', b'1', '1', NOW(), '1', NOW(), b'0'),
('生产订单导出', 'erp:production-order:export', 3, 5, @parentId, '', '', '', 0, b'1', b'1', b'1', '1', NOW(), '1', NOW(), b'0');
